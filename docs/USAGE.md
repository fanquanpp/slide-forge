...
- **适用场景**：Godot 工程 / godot-engine / 游戏资源
...
- **适用场景**：创作素材 / Aseprite / MMD / Blender
...
## SF-021 — 项目汇报与复盘 · 数学网格功能主义

- **适用场景**：课程/项目工程 / IDE / 历史 ppt
...
## SF-026 — 学习笔记分享 · 柔和科技图表

- **适用场景**：技术笔记 / 网络技术 / 编程大礼包
- **设计风格**：柔和科技图表（Soft Tech，锚点 17 Takram）——圆角、柔影与图表即艺术，适合作品集、产品提案与数据看板。
- **输入前提**：无需外部素材；打开即可编辑（PowerPoint / WPS / Keynote / LibreOffice）。
- **使用方法**：替换标题与正文占位文本 → 按需删除多余版面 → 批量替换主题色换成品牌色 → 用「插入-图片」替换图片占位框 → 需要时用「设计-幻灯片大小」保持 16:9。
- **注意事项**：字体依赖系统字体（微软雅黑 / Segoe UI 等），如需商用字体请自行确认授权；模板不含正式内容。
